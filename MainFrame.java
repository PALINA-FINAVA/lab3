...
// Добавить его в главное меню
        ...
        Action spravka = new AbstractAction("О программе") {
...
// и инициализировать текущей директорией
                ...
                JLabel imageLabel = new JLabel("Автор программы Финова Полина, 7 группа");
                JOptionPane.showMessageDialog(MainFrame.this,imageLabel, "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
...
saveToTextMenuItem.setEnabled(false);
    ...
    Action saveToGraphicsAction = new AbstractAction("Сохранить данные для построения графика") {public void actionPerformed(ActionEvent event) {
        if (fileChooser==null) {
...
// Пометить ряд элементов меню как доступных
                    ...
                    searchValueMenuItem.setEnabled(true);} catch (NumberFormatException ex) {
